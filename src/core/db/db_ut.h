 ...
 * \return zero on sucess, negative on conversion errors
 */
int db_str2double( char* _s, double* _v);
 ...
 * \return zero on sucess, negative on conversion errors
 */
int db_str2time( char* _s, time_t* _v);
 ...
 * \return the length of the printed result on success, negative on errors
 */
int db_print_values( db_con_t* _c, char* _b,  int _l,  db_val_t* _v,
 ...
 * \return the length of the printed result on success, negative on errors
 */
int db_print_where( db_con_t* _c, char* _b,  int _l,  db_key_t* _k,
	 db_op_t* _o,  db_val_t* _v,  int _n, int (*val2str)
	( 	db_con_t*,  db_val_t*, char*, int*));
 ...
 * \return the length of the printed result on success, negative on errors
 */
int db_print_set( db_con_t* _c, char* _b,  int _l,
	 db_key_t* _k,  db_val_t* _v,  int _n, int (*val2str)
	( db_con_t*,  db_val_t*, char*, int*));
