...
inline int db_str2int( char* _s, int* _v)
{
	long tmp;
 ...
 */
inline int db_str2double( char* _s, double* _v)
{
	if ((!_s) || (!_v)) {
		LM_ERR("Invalid parameter value\n");
		return -1;
 ...
 */
inline int db_str2time( char* _s, time_t* _v)
{
	struct tm time;
 ...
 */
int db_print_set( db_con_t* _c, char* _b,  int _l,  db_key_t* _k,
