...
#define ATTEMPT_DEFRAG

#define F_MALLOC_LARGE_LIMIT    65536
#define F_MALLOC_DEFRAG_LIMIT (F_MALLOC_LARGE_LIMIT * 20)
#define F_MALLOC_DEFRAG_PERCENT 10
